...
const timeline = computed(() => [
  ...
  },
  {
    ...
    descIt: 'Diploma ITS in Web Development completato. Corso intensivo full-stack con progetti reali, lavoro in team, stack moderno.',
    descEn: 'Completed ITS Diploma in Web Development. Intensive full-stack course with real projects, team work, modern stack.',
  },
  {
    period: '2026 — ' + (language.value === 'it' ? 'Oggi' : 'Today'),
    titleIt: language.value === 'it' ? 'Ricerca lavoro' : 'Job Hunting',
    titleEn: 'Job Hunting',
    descIt: 'Attualmente alla ricerca di opportunità lavorative come Junior Full Stack Developer per mettere alla prova le mie competenze e crescere professionalmente.',
    descEn: 'Currently seeking career opportunities as a Junior Full Stack Developer to apply my skills and grow professionally.',
    current: true,
  },
]);
