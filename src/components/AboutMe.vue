...
const timeline = computed(() => [
  ...
  },
  {
    ...
    descIt: 'Diploma ITS in Web Development. Corso intensivo full-stack con focus front-end, progetti reali, lavoro in team, stack moderno.',
    descEn: 'ITS Diploma in Web Development. Intensive full-stack course with front-end focus, real projects, team work, modern stack.',
  },
  {
    period: '2026 — ' + (language.value === 'it' ? 'Oggi' : 'Today'),
    titleIt: language.value === 'it' ? 'Ricerca lavoro' : 'Job Hunting',
    titleEn: 'Job Hunting',
    descIt: 'Attualmente alla ricerca di opportunità lavorative come Junior Web Developer / Front-end Developer per mettere alla prova le mie competenze e crescere professionalmente.',
    descEn: 'Currently seeking career opportunities as a Junior Web Developer / Front-end Developer to apply my skills and grow professionally.',
    current: true,
  },
]);
